<footer class="bg-gray-900 text-white pt-8 mt-8">
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        
        <!-- Sección 1: Logo y descripción -->
        <div>
            <h2 class="text-2xl font-bold">Mi Empresa</h2>
            <p class="mt-2 text-gray-400">Soluciones innovadoras para tu negocio.</p>
        </div>
        ...
        <div>
            ...
            <div class="flex justify-center md:justify-start mt-2 space-x-4">
                <a href="#" class="hover:text-gray-300">
                    ...
                    </svg> <!-- Ícono de Facebook -->
                </a>
                <a href="#" class="hover:text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                        <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                      </svg> <!-- Ícono de Twitter -->
                </a>
                <a href="#" class="hover:text-gray-300">
    ...
    <div class="border-t border-gray-700 mt-8 py-4 flex place-content-center text-gray-400">
